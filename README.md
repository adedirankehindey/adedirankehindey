...
<img src="https://skillicons.dev/icons?i=python,r,bash,js,ts,java,php,cpp,html,css,bootstrap,tailwind,react,jquery,laravel,nodejs,vue,mysql,postgres,mongodb,redis,git,github,docker,vscode&perline=8" />
